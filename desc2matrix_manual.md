# desc2matrix.py user manual

This document explains the up-to-date manual for using `desc2matrix.py`, which converts the description text files generated by the `Makefile` into a structured JSON output containing the traits and corresponding values.
