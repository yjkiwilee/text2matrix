...
# python desc2matrix_langchain_accum.py ../data/solanaceae-desc-subset.txt outputs/accum_output/accum_langchain_subset.json --desctype=general --temperature=0
...
python desc2matrix_langchain_wcharlist.py ../data/solanaceae-desc-subset.txt charlists/solanum_charlist_gen_longer.txt outputs/wcharlist_output/wcharlist_langchain_lgenlist_subset_2nd_pt2.json --desctype=general --charlistsep="; " --temperature=0 --start=60
