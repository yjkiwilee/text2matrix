...
method_labels <- c("Shorter trait list, without follow-up", "Shorter trait list, with follow-up", "Longer trait list, without follow-up", "Longer trait list, with follow-up")
...
ggsave(here::here("figures/subset_test/wcharlist_chars_recovered_gen_subset.png"), prop_given_histplots, width = 5, height = 6)
...
ggsave(here::here("figures/subset_test/wcharlist_chars_actual_gen_subset.png"), prop_actual_histplots, width = 5, height = 6)
