...
python desc2matrix_wcharlist_followup.py ../data/solanaceae-desc-subset.txt charlists/solanum_charlist_gen_shorter.txt outputs/wcharlist_output/wcharlist_f_sgenlist_subset_pt2.json --desctype=general --prompt=alternative_prompts/prompt_minimalinstruction.txt --charlistsep="; " --start=102
