...
method_labels <- c("Long trait list", "Long trait list w/ follow-up", "Short trait list", "Short trait list w/ follow-up")
...
charlists_given <- list(
  ...
  wcharlist_s = wcharlist_s_dat$charlist,
  wcharlist_sf = wcharlist_sf_dat$charlist
)
...
charlists_actual <- list(
  ...
  wcharlist_s = lapply(wcharlist_s_dat$data, data2charlist),
  wcharlist_sf = lapply(wcharlist_sf_dat$data, data2charlist)
)
...
ggsave(here::here("figures/wcharlist_prop_chars_recovered.png"), prop_given_histplots, width = 5, height = 6)
...
ggsave(here::here("figures/wcharlist_prop_chars_actual.png"), prop_actual_histplots, width = 5, height = 6)
