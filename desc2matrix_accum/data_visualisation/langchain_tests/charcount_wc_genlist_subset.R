...
wcharlist_dats <- list(
  ...
  wcharlist_lc_sg = wcharlist_lc_sg_dat,
  wcharlist_lg = wcharlist_lg_dat,
  wcharlist_f_lg = wcharlist_f_lg_dat,
  wcharlist_lc_lg = wcharlist_lc_lg_dat
)
...
method_lab <- c("Shorter trait list, without follow-up",
...
wcharlist_plt
ggsave(here::here("figures/langchain_test/charcount_wc_gen_subset.png"), wcharlist_plt, width = 6, height = 5)
...
status_plt
ggsave(here::here("figures/langchain_test/subsetstatus_wc_gen_subset.png"), status_plt, width = 6.5, height = 5)
