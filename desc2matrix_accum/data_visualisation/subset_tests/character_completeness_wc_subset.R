...
method_labels <- c("Without follow-up Q", "With follow-up Q")
...
ggsave(here::here("figures/subset_test/wcharlist_chars_recovered_subset.png"), prop_given_histplots, width = 5, height = 6)
